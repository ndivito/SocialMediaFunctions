...
CLIENT_SECRETS_FILE = 'client.json'  #make as an environment variable or other secret
...
def get_authenticated_service():  # Modified
    credential_path = os.path.join('./', 'credential.json')  #Remake credential file as secret of some sort
